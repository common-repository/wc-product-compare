...
class WCPC_Template {
	...
	public function __construct() {
		$this->template_url = 'wc-product-compare/';
	}
	...
	public function locate_template($template_name, $template_path = '', $default_path = '') {
		...
		if (!$default_path)
			$default_path = $WCPC->plugin_path . 'templates/';
	...
	public function get_template_part($slug, $name = '') {
		...
		if (!$template && $name && file_exists($WCPC->plugin_path . "templates/{$slug}-{$name}.php"))
			$template = $WCPC->plugin_path . "templates/{$slug}-{$name}.php";
